    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert([{
          ...
          image_url: imageUrl.trim() || 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&auto=format&fit=crop&q=60', // beautiful default fallback image
          published,
          author_id: user.id,
          views: 0
        }])
      ...
      if (error) {
        if (error.code === '23505') { // Unique constraint violation on slug in PostgreSQL
          throw new Error('This URL slug is already taken. Please modify the slug or title.')
        }
        throw error
      }

      setMessage({ type: 'success', text: 'Article created successfully! Redirecting...' })
      setTimeout(() => {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-zinc-400 text-sm font-medium">Preparing writing desk...</span>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-5xl mx-auto space-y-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-zinc-800/60 pb-6">
          <div className="space-y-1">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight">Create New Story</h1>
            <p className="text-sm text-zinc-400">Plug in your thoughts, format in Markdown, and schedule or publish.</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="glassmorphism rounded-3xl p-6 border border-zinc-800/50 space-y-6">
              ...
              <div className="space-y-1">
                ...
                />
                <p className="text-[10px] text-zinc-500">Provide an Unsplash or custom CDN image URL.</p>
              </div>
              ...
              <div className="pt-2">
                <label className="flex items-center gap-3 cursor-pointer group select-none">
                  ...
                  />
                  <div>
                    <span className="text-sm font-bold text-white group-hover:text-primary-400 transition-colors">Publish immediately</span>
